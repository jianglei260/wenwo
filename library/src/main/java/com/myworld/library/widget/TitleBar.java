package com.myworld.library.widget;
...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        leftImageRes = ta.getResourceId(R.styleable.TitleBar_leftImage, R.drawable.ic_add);
        rightImageRes = ta.getResourceId(R.styleable.TitleBar_rightImage, R.drawable.ic_add);
